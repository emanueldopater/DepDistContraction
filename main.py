...
# loading networks
loaded_karate_club = load_net_from_edge_list(path='datasets/airports_reindexed.csv', sep=';', has_edge_weights = True)
...
#     embedding_dists += embedding_karate_club.distances

# #plot as bar plot
# plt.bar(range(len(embedding_dists)),embedding_dists)
# plt.show()
