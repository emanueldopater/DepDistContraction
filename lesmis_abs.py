...
# genetic_embedding = GeneticEmbeddingAbsLogEachNeigh(network=lesmis_network, dependency_matrix=dep_matrix, embedding_dim=2,
...
#export_to_gdf('gdf_files/lesmis_abs_27_07_2023.gdf', lesmis_network, genetic_embedding.get_embeddings(), has_labels=True)
